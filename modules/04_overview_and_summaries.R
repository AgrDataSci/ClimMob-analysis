#' Produces the trial summary tables and overview
#' 
...
#' 
#' overview = get_overview_summaries(cmdata, rank_dat)
#' 
#' overview$summary_table_trait
#' overview$summary_table_tech
#' overview$partipation_plot
#' overview$trial_connectivity
#' 
#' @export
