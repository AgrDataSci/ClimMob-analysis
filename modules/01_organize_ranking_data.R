# This module organize the data using internal parameters and
# the parameters sent by ClimMob to get the data read for the 
# next modules
...
# check if a request to split the data by groups 
