...
p2<-favourability_plot(fav1)+ggtitle(trait_short[i])+ylim(-100,100)+xlab(option)
```

```{r}
kable(fav2[nrow(fav2):1,],row.names = FALSE,
      caption=paste("Table 2.2.",i,": Favourability Statistics for ",trait_short[i],sep=""))
```
