...
Favourability scores are shown for the trait '`r tolower(other_traits_list[[i]]$name)`' which was collected during the data collection moment registered as '`r other_traits_list[[i]]$assessment`'. The `r rankers` were asked to evaluated the best and worst `r option` based on the question: '`r other_traits_list[[i]]$question`'.
...
```{r, dpi=dpi, fig.height=favplot_h, fig.width=6, fig.cap= paste0("Figure 3.", i, ".1. Net favourability scores for '",tolower(other_traits_list[[i]]$name),"'.")}
p2
```
