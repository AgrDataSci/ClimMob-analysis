...
```{r temperature_indices, dpi=dpi, fig.height=10, fig.width=10, fig.cap=paste0("Temperature indices from ", paste(agroclimate$dates, collapse = " to "), ". The chart presents the maximum day temperature (maxDT), the minimum day temperature (minDT), the maximum night temperature (maxNT), and the minimum nigth temperature (minNT).")}
if (isTRUE(agroclimate$agroclimate)){
