...
if (isTRUE(PL_tree$isTREE)) {
  ...
  tree_test2 <- 
    paste0("Figure 1.6 shows the Plackett-Luce tree obtaioned with the selected model.")
...
```{r pltree, dpi=500, asis=TRUE,fig.height=8,fig.width=10, fig.cap = paste0("Fig. 1.6. Plackett-Luce tree of tested ", options, ". The horizontal axis of each panel is the log-worth. Error bars show quasi-SEs. The gray vertical lines indicate the reference.")}
if (isTRUE(PL_tree$isTREE)) {
