...
```{r worthmap, dpi=dpi,fig.height=worthmap_h, fig.width=worthmap_w, fig.cap= paste0("Figure 1.4. Probability of winning (worth) by traits of ", options, " tested in this experiment. The values are adjusted to the log scale where worth > 0 (blue) represents the ", options, " with superior performance for the given trait, whereas worth < 0 (red) represents the ", options, " with the lower performance for the given trait.")}
if (length(worthmap) > 0) {
