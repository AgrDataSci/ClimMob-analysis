...
```{r kendall_tau_plot}
if (isTRUE(nrow(PL_models$kendall$kendall) > 0)) {
  kable(PL_models$kendall$kendall_plot,
        caption = paste0("Correlation between '", reference_trait, "' and the other traits assessed in this trial. The table displays Kendall correlation coefficients with p < 0.05 indicating significant correlation between traits."),
          align = "l",
          row.names = FALSE)
}
```
