...
If you would like to have an in-deep analysis, or to merge data from different projects or is planning a peer-review publication with your tricot data, send a proposal/request to Kauê de Sousa (k.desousa@cgiar.org) and Jacob van Etten (j.vanetten@cgiar.org).
...
Figure 1.5 shows that the `r ntechnologies` are all connected to each other. That means that they all co-occurred at least once in an incomplete block of `r noptions` `r options`. 
