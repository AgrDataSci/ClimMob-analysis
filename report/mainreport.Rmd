...
> If you publish the results presented in this report you should cite a number supporting tools and approaches that the report relies on. The decentralized experimental approach behind ClimMob is introduced by van Etten et al. (2019) [@vanEtten2019tricot]. To cite ClimMob itself, mention van Etten et al. (2020) [@climmob]. The workflow used to produce this report is documented by de Sousa et al. (2022) [@climmobanalysis].
...
if (isFALSE(is.null(error))){
  e <- paste("During the execution of the requested analysis",
             ...
             "Kauê de Sousa <k.desousa@cgiar.org> and",
             "to Brandon Madriz <bmadriz@mrbotcr.com>.")
}
```
